...
/* AÞAÐIDAKÝ ÇÖZÜM ALLEN HOCA'YA AÝTTÝR. */
...
SELECT	sc.customer_id, 
		...
		pp.product_name
INTO	#jointable     -- Temporary table oluþturma
...
--DROP TABLE IF EXISTS #jointable;   -- temporary table'ý kullandýktan sonra silmek için
